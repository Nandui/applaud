...
function DropdownMenuItem({
  ...
  // Bridge radix's `onSelect` API onto Base UI's `onClick`. radix consumers call
  // `event.preventDefault()` inside `onSelect` to keep the menu open after a
  // selection; Base UI's equivalent is `event.preventBaseUIHandler()`.
  const handleClick: React.ComponentProps<
